...
fixed_metarlbo_amp_cnn_002 = { # 001 but (num_meta_updates_per_iter 30 -> 50)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-002",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_003 = { # 001 but (diversity threshold 10 -> 1)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-003",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_004 = { # 001 but (entropy_reg_coeff 0.0 -> 0.1)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-004",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_005 = { # 005 but (num_proxies 8 -> 4)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-005",
	"num_proxies": 4,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_006 = { # 005 but (num_meta_updates_per_iter 50 -> 80)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-006",
	"num_proxies": 4,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_007 = { # 002 but (num_samples_per_proxy 100 -> 256)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-007",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_008 = { # 007 but (proxy_oracle's -- p 0.8 -> 0.7)
	"exp_label": "Fixed-MetaRLBO-AMP-CNN-008",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
fixed_metarlbo_amp_cnn_009 = { # 005 but (p 0.8 -> 1.0)
...
metarlbo_amp_mlp_004 = {
	"exp_label": "MetaRLBO-AMP-MLP-004",
	"num_proxies": 4,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
metarlbo_amp_cnn_003 = { # Same as 001 but with entropy bonus
	"exp_label": "MetaRLBO-AMP-CNN-003",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
metarlbo_amp_cnn_004 = { # Same as 001 but with more entropy bonus
	"exp_label": "MetaRLBO-AMP-CNN-004",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
...
metarlbo_amp_cnn_005 = { # Same as 001 but with more entropy bonus
	"exp_label": "MetaRLBO-AMP-CNN-005",
	"num_proxies": 8,
	"num_inner_updates": 1,
	"num_initial_samples": 250,
	"num_query_proxies": 32,
