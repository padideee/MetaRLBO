...
Thesis_metarlbo_ising20_052_1 = { # Copy 040 (w/ num_meta_updates_per_iter 50 -> 80)
    "exp_label": "THESIS_MetaRLBO-Ising20-CNN-052_1",
    "task": "AltIsing20-v0",
    "num_proxies": 4,
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
Thesis_metarlbo_ising20_052_2 = { # Copy 040 (w/ num_meta_updates_per_iter 50 -> 80)
    "exp_label": "THESIS_MetaRLBO-Ising20-CNN-052_2",
    "task": "AltIsing20-v0",
    "num_proxies": 4,
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_064 = { # Copy 063 -- but reset_policy_per_round = True
    "exp_label": "MetaRLBO-Ising20-CNN-064",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_065 = { # Copy 064 -- but increase num_meta_updates_per_iter: 80 -> 160
    "exp_label": "MetaRLBO-Ising20-CNN-065",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_066 = { # Copy 065 -- but increase num_meta_updates_per_iter: 160 -> 240
    "exp_label": "MetaRLBO-Ising20-CNN-066",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_067 = { # Copy 063 -- but num_meta_updates_per_iter: 80 -> 160
    "exp_label": "MetaRLBO-Ising20-CNN-067",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_068 = { # Copy 063 but (num_steps: 150 -> 81, num_meta_steps: 50 -> 61)
    "exp_label": "MetaRLBO-Ising20-CNN-068",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
    ...
    "policy": {
        "num_steps": 81, # number of steps (per env) before updating... ensure this is at least as big as the length of the episode of the environment
        "num_meta_steps": 61,
    },
    "selection_criteria": { # Configs for selecting the samples
        "method": "UCB", 
...
metarlbo_ising20_069 = { # Copy 068 (but reset_policy: False -> True)
    "exp_label": "MetaRLBO-Ising20-CNN-069",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_070 = { # Copy 069 (but num_meta_updates_per_iter: 80 -> 120)
    "exp_label": "MetaRLBO-Ising20-CNN-070",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_071 = { # Copy 063 -- but num_samples_per_proxy: 64 -> 128 
    "exp_label": "MetaRLBO-Ising20-CNN-071",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_072 = { # Copy 063 -- but num_samples_per_proxy: 64 -> 128  and num_meta_updates_per_iter: 80 -> 100
    "exp_label": "MetaRLBO-Ising20-CNN-072",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_073 = { # Copy 063 -- but num_samples_per_proxy: 64 -> 128  and num_meta_updates_per_iter: 80 -> 100 and entropy_reg_coeff: 0.2 -> 0.5
    "exp_label": "MetaRLBO-Ising20-CNN-073",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_074 = { # Copy 063 -- but num_samples_per_proxy: 64 -> 128 and num_inner_updates: 1 -> 2
    "exp_label": "MetaRLBO-Ising20-CNN-074",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 2,
...
metarlbo_ising20_075 = { # Copy 063 but lambda: 1.0 -> 0.5
    "exp_label": "MetaRLBO-Ising20-CNN-075",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
...
metarlbo_ising20_076 = { # Copy 063  w/ il, ol -> 2.0, 0.2
    "exp_label": "MetaRLBO-Ising20-CNN-076",
    "task": "AltIsing20-v0",
    "num_proxies": 4, 
    "max_num_queries": 8000, # Maximum number of queries in experiment
    "num_inner_updates": 1,
