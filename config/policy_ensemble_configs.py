...
policy_ensemble_rna_003= { # Based on RNA14_026 -- num_policies: 4 -> 2
    "exp_label": "Policy_Ensemble-RNA14-003",
    "task": "RNA14-v0",
    "use_ensemble_learner": True,
    "max_num_queries": 1500, # Maximum number of queries in experiment
    "num_policies": 2, # Essentially, the number of policies -- and this is equivalent to the num_query_proxies in MetaRLBO
    "num_initial_samples": 100,
    "num_samples_per_policy": 1024,
    "num_query_per_iter": 100,
    "num_updates_per_iter": 50,  # Number of updates per iter for each of the policies! 
    "entropy_reg_coeff": 0.2,
    "proxy_oracle": {
...
policy_ensemble_rna_004= { # Based on RNA14_026 -- num_policies: 4 -> 1
    "exp_label": "Policy_Ensemble-RNA14-004",
    "task": "RNA14-v0",
    "use_ensemble_learner": True,
    "max_num_queries": 1500, # Maximum number of queries in experiment
    "num_policies": 1, # Essentially, the number of policies -- and this is equivalent to the num_query_proxies in MetaRLBO
    "num_initial_samples": 100,
    "num_samples_per_policy": 2048,
    "num_query_per_iter": 100,
    "num_updates_per_iter": 50,  # Number of updates per iter for each of the policies! 
    "entropy_reg_coeff": 0.2,
    "proxy_oracle": {
...
policy_ensemble_rna_005= { # Based on RNA14_026 -- num_policies: 4 -> 16
    "exp_label": "Policy_Ensemble-RNA14-005",
    "task": "RNA14-v0",
    "use_ensemble_learner": True,
    "max_num_queries": 1500, # Maximum number of queries in experiment
    "num_policies": 16, # Essentially, the number of policies -- and this is equivalent to the num_query_proxies in MetaRLBO
    "num_initial_samples": 100,
    "num_samples_per_policy": 128,
    "num_query_per_iter": 100,
    "num_updates_per_iter": 50,  # Number of updates per iter for each of the policies! 
    "entropy_reg_coeff": 0.2,
    "proxy_oracle": {
