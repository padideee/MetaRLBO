...
from utils.ppo_utils import init
...
class MLPBase(NNBase):
    def __init__(self, num_inputs, recurrent=False, hidden_size=128): # Prev 64
...
class MLPBaseNoCritic(NNBase):
    def __init__(self, num_inputs, recurrent=False, hidden_size=128): # Prev 64
        super(MLPBaseNoCritic, self).__init__(recurrent, num_inputs, hidden_size)
    ...
    def forward(self, inputs, rnn_hxs, masks):
        ...
        return torch.tensor(0), hidden_actor, rnn_hxs
